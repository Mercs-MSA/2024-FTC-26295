...
public class MecanumDrivingSampleOdometry extends LinearOpMode {
    ...
    private DcMotor auxEncoder = null;
    ...
    //shadow the Motors with ODO Encoders
        leftEncoder  = leftBackDrive;
        rightEncoder = rightBackDrive;
        auxEncoder = rightFrontDrive;
...
*/
    ...
    final static double L = 20.12; // distance between encoder 1 - 2
