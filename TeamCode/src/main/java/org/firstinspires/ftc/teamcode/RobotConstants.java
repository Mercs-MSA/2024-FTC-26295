...
public class RobotConstants
{
    ...
    //Intake Mechanism
    public static final int LINEARSLIDEELEVATOR_RESET_POSITION = 0;//Lowest position, on the floor
    public static final int LINEARSLIDEELEVATOR_TOP_RUNG_PLACE = -2100;//Upper rung starting position
    ...
    // Climb mechanism
    public static final int CLIMBELEVATOR_RESET_RELEASE = 0;//Upper rung pull down position
