...
public final class MecanumDrive {
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer() {
            leftFront = new OverflowEncoder(new RawEncoder(MecanumDrive.this.leftFrontDrive));
            leftBack = new OverflowEncoder(new RawEncoder(MecanumDrive.this.leftBackDrive));
            rightBack = new OverflowEncoder(new RawEncoder(MecanumDrive.this.rightBackDrive));
            rightFront = new OverflowEncoder(new RawEncoder(MecanumDrive.this.rightFrontDrive));
